...
module ext_IUser =
    ...
    type IUser with
        ...
        member self.ReadPostPermissionLevel =
            self.Permission &&& 3072us >>> 10

        member self.WritePostPermissionLevel =
            self.Permission &&& 300us >>> 8

        member self.ReadCommentPermissionLevel =
            self.Permission &&& 192us >>> 6

        member self.WriteCommentPermissionLevel =
            self.Permission &&& 48us >>> 4

        member self.ReadUserPermissionLevel =
            self.Permission &&& 12us >>> 2

        member self.WriteUserPermissionLevel =
            self.Permission &&& 3us
