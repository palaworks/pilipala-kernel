...
type IPostStoragePipelineBuilder =
    abstract member cover: BuilderItem<u64 * string>
    abstract member title: BuilderItem<u64 * string>
    abstract member summary: BuilderItem<u64 * string>
    abstract member body: BuilderItem<u64 * string>
    abstract member ctime: BuilderItem<u64 * DateTime>
    abstract member mtime: BuilderItem<u64 * DateTime>
    abstract member atime: BuilderItem<u64 * DateTime>
